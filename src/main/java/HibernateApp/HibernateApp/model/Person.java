...
public class Person {
	...
	@Id
	// @GeneratedValue annotation is assigned to column which is generated by database, in our case we add strategy because in database we use syntax "GENERATED BY DEFAULT AS IDENTITY"
